  ...
  return (
    <main className="mx-auto max-w-lg px-6 min-h-screen flex flex-col justify-center">
      <div className="text-center mb-10">
        <div className="w-16 h-16 bg-[var(--primary)] rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-xl relative overflow-hidden">
      ...
      <div className="card-royal p-10 bg-[var(--surface)]">
        <form className="space-y-6" onSubmit={onSubmit}>
          ...
          <p className="text-center text-sm font-bold text-[var(--text-secondary)]">
            New here?{' '}
            <Link className="text-[var(--primary)] hover:underline decoration-2 underline-offset-4" href="/register">
              Create account
            </Link>
          </p>
        </form>
